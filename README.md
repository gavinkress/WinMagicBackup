...
* BackupTarget: Outer function which houses the custom backup data collection and extraction methods as inner functions and calls them based on the index of the backup item - [function[function]]
  * The current functions backup your Environment Variables, create a list of your Current Apps, and creates a full backup of your WSL Ubuntu, Docker, and Kali Linux Environments as .tar files, creates a piptools requirements.txt file for your python environment(s), and an image of your W11 registry.
